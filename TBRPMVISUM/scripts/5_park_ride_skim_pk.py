...
mx_skims = {'dis': 8, 'ivt': 39, 'owt': 28, 'twt': 29, 'ntr': 31, 'far': 32, 'act': 30, 'wkt': 99, 'egt': 100}
mx_result= {'act': "outputs\\{}\\skims\\park_ride_pk.ACT".format(SCNAME), 'owt': "outputs\\{}\\skims\\park_ride_pk.OWT".format(SCNAME), 'twt': "outputs\\{}\\skims\\park_ride_pk.TWT".format(SCNAME), 
'ivt': "outputs\\{}\\skims\\park_ride_pk.IVT".format(SCNAME), 'ntr': "outputs\\{}\\skims\\park_ride_pk.NTR".format(SCNAME), 'far': "outputs\\{}\\skims\\park_ride_pk.FAR".format(SCNAME), 'act': "outputs\\{}\\skims\\park_ride_pk.ACT".format(SCNAME), 'wkt': "outputs\\{}\\skims\\park_ride_pk.WKT".format(SCNAME)} 
...
mat4 = 41 #KnR best lot
# dict of skims to compose for mode choice     put_owt = h.GetMatrixRaw(Visum, mx_skims['owt']) , put_twt = h.GetMatrixRaw(Visum, mx_skims['twt']) 
mx_skims = {'dis': 8, 'ivt': 39, 'owt': 28, 'twt': 29, 'ntr': 31, 'far': 32, 'act': 30, 'wkt': 99, 'egt': 100}
mx_result= {'act': "outputs\\{}\\skims\\kiss_ride_pk.ACT".format(SCNAME), 'owt': "outputs\\{}\\skims\\kiss_ride_pk.OWT".format(SCNAME), 'twt': "outputs\\{}\\skims\\kiss_ride_pk.TWT".format(SCNAME), 
'ivt': "outputs\\{}\\skims\\kiss_ride_pk.IVT".format(SCNAME), 'ntr': "outputs\\{}\\skims\\kiss_ride_pk.NTR".format(SCNAME), 'far': "outputs\\{}\\skims\\kiss_ride_pk.FAR".format(SCNAME), 'act': "outputs\\{}\\skims\\kiss_ride_pk.ACT".format(SCNAME), 'wkt': "outputs\\{}\\skims\\kiss_ride_pk.WKT".format(SCNAME)} 
skim_parkride(mat1, mat2, TERMTME, mat4, prflag, mx_skims, mx_result) 
