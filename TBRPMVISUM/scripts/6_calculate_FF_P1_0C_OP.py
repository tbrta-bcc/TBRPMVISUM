...
def calculate_FF(dstrat, skmno, ffmxno, fftable, ffcoln):
    ...
    SKM = h.GetMatrixRaw(Visum, skmno) #/ 60.0           #convert IMP in seconds to minutes
...
skmno  =  6 
dstrats= {'HBO': ["FF_ALL", "HBO", 23], 'HBSC': ["FF_ALL", "HBSC", 24], 'HBSH': ["FF_ALL", "HBSH", 25], 
'HBSR': ["FF_ALL", "HBSR", 26], 'HBW': ["FF_HBW_0C_OP", "HBW_0C", 27]}

# removed--> 'AIRP': ["FF_ALL", "AIRP", 21], 'COL': ["FF_ALL", "COL", 22]
