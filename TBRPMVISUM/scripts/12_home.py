...
<div class="flex-shrink-0 p-3" style="width: 230px;background-color:#F2F2F2">
    ...
    <ul class="list-unstyled ps-0">
      <li><a href="Home.html" class="btn btn-toggle d-inline-flex align-items-center rounded border-0" aria-expanded="false" style="background-color:ADCEDE">Home</a></li>
      <li class="mb-1">
...
main_continue="""
  ...
  <div class="sysreq" id="sysreq">
  <img src="images/visum_sysreq.png" style="width:90%; height:90%" >
  </div>
...
end_html = """
        ...
        """
if base==1:
  html = title +diff_45+ main_continue + end_html
else:
  html = title + main_continue + end_html


text_file = open(os.path.join(Visum.GetPath(2), "outputs\\{}\\HTML\\Home.html".format(scname)), "w")
