...
writer=pd.ExcelWriter(os.path.join(Visum.GetPath(2), "outputs\\{}\\summaries\\Intrazonal_PK_County.xlsx".format(scname)),engine="xlsxwriter")
...
msg1="Hillsborough Peak Intrazonal Trips"
msg2="Pinellas Peak Intrazonal Trips"

msg3="Pasco Peak Intrazonal Trips"

msg4="Hernando Peak Intrazonal Trips"

msg5="Citrus Peak Intrazonal Trips"
msg6="Other Peak Intrazonal Trips"
        ...
        <div class="collapse show" id="dashboard-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            ...
            <li><a href="Triplength_OP_County.html" class="link-dark d-inline-flex text-decoration-none rounded"  >OP Trip Length by County </a></li>
             ...
             <li><a href="DIST_intra_County_PK.html" class="link-dark d-inline-flex text-decoration-none rounded" style="background-color:ADCEDE">PK Intrazonal Trips by County </a></li>
...
text_file = open(os.path.join(Visum.GetPath(2), "outputs\\{}\\HTML\\DIST_intra_County_PK.html".format(scname)), "w")
